"""Run exact Krylov projection for H2."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--n-steps", type=int, default=2, help="Number of Krylov steps.")
    parser.add_argument("--krylov-method", choices=["exact", "lanczos"], default="exact")
    parser.add_argument("--array-backend", choices=["auto", "numpy", "cupy"], default="numpy")
    add_common_output_arg(parser, "exact_krylov_h2")
    return parser
...
def main() -> int:
    ...
    print("Exact Krylov eigenvalues:", energies)
    write_summary(
        args.output_dir,
        {
